...
final class RouteTests: XCTestCase {
    ...
    func testUpdateOptionalParameterValueWithEmptyParameterName() {
        // Arrange
        var route = Route(method: .GET, path: "/blog/{page?1}") { request in Response() }!

        // Act
        route.updateParameter(named: "", value: "2")
    ...
    func testUpdateOptionalParameterDefaultValueWithEmptyDefaultValue() {
        // Arrange
        var route = Route(method: .GET, path: "/blog/{page?1}") { request in Response() }!

        // Act
        route.updateParameter(named: "page", defaultValue: "")
    ...
    func testUpdateOptionalParameterDefaultValueWithNewDefaultValue() {
        // Arrange
        var route = Route(method: .GET, path: "/blog/{page?1}") { request in Response() }!
    ...
    func testUpdateOptionalParameterDefaultValueWithWrongParameterName() {
        // Arrange
        var route = Route(method: .GET, path: "/blog/{page?1}") { request in Response() }!

        // Act
        route.updateParameter(named: "page2", defaultValue: "2")
    ...
    func testUpdateOptionalParameterDefaultValueWithEmptyParameterName() {
        // Arrange
        var route = Route(method: .GET, path: "/blog/{page?1}") { request in Response() }!

        // Act
        route.updateParameter(named: "", defaultValue: "2")
    ...
    func testUpdateOptionalParameterValueAndDefaultValueWithNewValueAndNewDefaultValue() {
        // Arrange
        var route = Route(method: .GET, path: "/blog/{page?1}") { request in Response() }!

        // Act
        route.updateParameter(named: "page", value: "2", defaultValue: "3")

        // Assert
        XCTAssertEqual(route.parameters?.count, 1)
        XCTAssertEqual(route.path, "/blog/{page?3}")
        XCTAssertEqual(route.pattern, "/blog(/.+|3)?")
        XCTAssertEqual(route.parameters?.first?.value, "2")
    }

    func testUpdateOptionalParameterValueAndDefaultValueWithWrongParameterName() {
        // Arrange
        var route = Route(method: .GET, path: "/blog/{page?1}") { request in Response() }!

        // Act
        route.updateParameter(named: "page2", value: "2", defaultValue: "3")
    ...
    func testUpdateOptionalParameterValueAndDefaultValueWithEmptyParameterName() {
        // Arrange
        var route = Route(method: .GET, path: "/blog/{page?1}") { request in Response() }!

        // Act
        route.updateParameter(named: "", value: "2", defaultValue: "3")
    ...
    func testUpdateForcedParameterValueWithEmptyValue() {
        // Arrange
        var route = Route(method: .GET, path: "/blog/{page!1}") { request in Response() }!
    ...
    func testUpdateForcedParameterValueWithNewValue() {
        // Arrange
        var route = Route(method: .GET, path: "/blog/{page!1}") { request in Response() }!
    ...
    func testUpdateForcedParameterValueWithWrongParameterName() {
        // Arrange
        var route = Route(method: .GET, path: "/blog/{page!1}") { request in Response() }!
    ...
    func testUpdateForcedParameterValueWithEmptyParameterName() {
        // Arrange
        var route = Route(method: .GET, path: "/blog/{page!1}") { request in Response() }!
    ...
    func testUpdateForcedParameterDefaultValueWithEmptyDefaultValue() {
        // Arrange
        var route = Route(method: .GET, path: "/blog/{page!1}") { request in Response() }!
    ...
    func testUpdateForcedParameterDefaultValueWithWrongParameterName() {
        // Arrange
        var route = Route(method: .GET, path: "/blog/{page!1}") { request in Response() }!
    ...
    func testUpdateForcedParameterDefaultValueWithEmptyParameterName() {
        // Arrange
        var route = Route(method: .GET, path: "/blog/{page!1}") { request in Response() }!
    ...
    func testUpdateForcedParameterValueAndDefaultWithEmptyValueAndEmptyDefaultValue() {
        // Arrange
        var route = Route(method: .GET, path: "/blog/{page!1}") { request in Response() }!
    ...
    func testUpdateForcedParameterValueAndDefaultValueWithNewValueAndNewDefaultValue() {
        // Arrange
        var route = Route(method: .GET, path: "/blog/{page!1}") { request in Response() }!
    ...
    func testUpdateForcedParameterValueAndDefaultValueWithWrongParameterName() {
        // Arrange
        var route = Route(method: .GET, path: "/blog/{page!1}") { request in Response() }!
    ...
    func testUpdateForcedParameterValueAndDefaultValueWithEmptyParameterName() {
        // Arrange
        var route = Route(method: .GET, path: "/blog/{page!1}") { request in Response() }!
