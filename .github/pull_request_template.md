...
7. [ ] You have updated the inline code documentation and [README](https://github.com/chaqmoq/routing/blob/master/README.md) accordingly
...
[![Actions Status](https://github.com/chaqmoq/routing/actions/workflows/development.yaml/badge.svg?branch=your-branch-name)](https://github.com/chaqmoq/routing/actions/workflows/development.yaml?branch=your-branch-name)
